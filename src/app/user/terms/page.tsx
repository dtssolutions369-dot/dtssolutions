    ...
    <div className="min-h-screen bg-white font-sans text-gray-800">
      ...
      <div className="bg-gradient-to-b from-[#FEF3C7] to-[#FFFDF5] pt-16 pb-20 px-6 relative border-b border-yellow-100">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-gray-900 leading-none uppercase mb-6">
            TERMS OF <br /> <span className="text-red-600 italic">SERVICE</span>
          </h1>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="space-y-12 text-sm leading-relaxed text-gray-600">
          ...
          {/* 1. OUR SERVICES */}
          <section id="s1">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">1. Our Services</h3>
          ...
          <section id="s2">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">2. Intellectual Property Rights</h3>
          ...
          <section id="s3">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">3. User Representations</h3>
          ...
          <section id="s6" className="bg-gray-900 text-white p-8 rounded-3xl">
            <h3 className="text-xl font-black mb-6 uppercase text-yellow-400 italic">6. Purchases, Payments & Subscriptions</h3>
          ...
          <section id="s9">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">9. Prohibited Activities</h3>
          ...
          {/* 14. SOCIAL MEDIA */}
          <section id="s14">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">14. Social Media</h3>
          ...
          <section id="s15">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">15. Third-Party Websites and Content</h3>
          ...
          <section id="s18">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">18. Term and Termination</h3>
            ...
            <h3 className="text-lg font-black text-gray-900 mt-8 mb-4 uppercase italic tracking-tighter">19. Modifications and Interruptions</h3>
          ...
          <section id="s20">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">20. Governing Law</h3>
            ...
            <h3 className="text-lg font-black text-gray-900 mt-8 mb-4 uppercase italic tracking-tighter">21. Dispute Resolution</h3>
          ...
          <section id="s23" className="border-2 border-red-600 p-8 rounded-3xl">
            <h3 className="text-red-600 font-black mb-4 uppercase italic tracking-tighter">23. Disclaimer</h3>
            ...
            <h3 className="text-gray-900 font-black mb-4 uppercase italic tracking-tighter">24. Limitations of Liability</h3>
          ...
          <section id="s27">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">27. Electronic Communications</h3>
          ...
          {/* 29. MISCELLANEOUS */}
          <section id="s29">
            <h3 className="text-lg font-black text-gray-900 mb-4 uppercase italic tracking-tighter">29. Miscellaneous</h3>
          ...
          <section id="s30" className="pt-12 border-t border-gray-100">
            <div className="flex flex-col md:flex-row gap-12 items-center">
              <div className="flex-1">
                <h3 className="text-3xl font-black text-gray-900 mb-4 uppercase italic tracking-tighter">30. Contact Us</h3>
                ...
                <div className="bg-white border-2 border-black p-8 rounded-2xl shadow-[10px_10px_0px_0px_rgba(220,38,38,1)]">
                  <div className="space-y-1 font-bold text-gray-900 uppercase tracking-tight">
                    <p className="text-red-600 text-xl font-black italic mb-2 tracking-tighter">QICKTICK (QT)</p>
              ...
              <div className="w-full md:w-1/3 bg-[#FEF3C7] p-8 rounded-3xl border border-yellow-200">
                ...
                <p className="text-sm font-bold text-gray-800 leading-tight italic">
